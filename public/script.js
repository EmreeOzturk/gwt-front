...
function m(someArgument) {
  console.log("Inside m, someArgument:", someArgument);
  if (someArgument && someArgument.length > 0) {
    for (
      var e,
        n = document.getElementById(someArgument),
        //@ts-ignore
...
window.onload = function () {
  let someVariable = document.getElementById("logo");
  console.log("Inside window.onload, someVariable:", someVariable);
  m(someVariable);
};
